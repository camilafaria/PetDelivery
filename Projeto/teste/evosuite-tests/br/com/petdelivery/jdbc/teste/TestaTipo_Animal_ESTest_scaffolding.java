...
public class TestaTipo_Animal_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.com.petdelivery.jdbc.teste.TestaTipo_Animal"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TestaTipo_Animal_ESTest_scaffolding.class.getClassLoader() ,
      "oracle.jdbc.driver.OracleDriver$1",
      "br.com.petdelivery.jdbc.teste.TestaTipo_Animal",
      "oracle.sql.Datum",
      "oracle.jdbc.driver.OracleDiagnosabilityMBean",
      "oracle.jdbc.driver.DiagnosabilityMXBean",
      "oracle.sql.TypeDescriptorFactory",
      "br.com.petdelivery.jdbc.dao.Tipo_AnimalDAO",
      "oracle.jdbc.driver.DatabaseError",
      "oracle.jdbc.driver.Message",
      "oracle.jdbc.OracleConnection",
      "oracle.jdbc.internal.ObjectDataFactory",
      "br.com.petdelivery.jdbc.modelo.Tipo_Animal",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TestaTipo_Animal_ESTest_scaffolding.class.getClassLoader()); 
