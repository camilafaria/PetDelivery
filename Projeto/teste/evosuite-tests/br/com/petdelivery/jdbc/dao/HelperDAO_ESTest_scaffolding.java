...
public class HelperDAO_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.com.petdelivery.jdbc.dao.HelperDAO"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HelperDAO_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "br.com.petdelivery.jdbc.dao.HelperDAO",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HelperDAO_ESTest_scaffolding.class.getClassLoader()); 
