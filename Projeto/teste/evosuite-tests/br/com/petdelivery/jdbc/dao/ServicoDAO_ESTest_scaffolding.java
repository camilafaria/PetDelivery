...
public class ServicoDAO_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.com.petdelivery.jdbc.dao.ServicoDAO"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ServicoDAO_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "br.com.petdelivery.jdbc.dao.ServicoDAO",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ServicoDAO_ESTest_scaffolding.class.getClassLoader()); 
