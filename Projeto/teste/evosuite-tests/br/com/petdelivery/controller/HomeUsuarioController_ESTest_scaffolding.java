...
public class HomeUsuarioController_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.com.petdelivery.controller.HomeUsuarioController"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HomeUsuarioController_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "oracle.sql.ORAData",
      "br.com.petdelivery.jdbc.dao.Agenda_ServicoDAO",
      "br.com.petdelivery.jdbc.ConnectionFactory",
      "oracle.jdbc.internal.OracleConnection",
      "br.com.petdelivery.jdbc.modelo.Prestador",
      "br.com.petdelivery.jdbc.modelo.Agenda_Servico",
      "br.com.petdelivery.jdbc.dao.AnimalDAO",
      "br.com.petdelivery.jdbc.modelo.Usuario",
      "oracle.jdbc.OracleDriver",
      "oracle.net.ns.NetException",
      "br.com.petdelivery.controller.HomeUsuarioController",
      "oracle.jdbc.driver.OracleDriver"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("javax.servlet.http.HttpServletRequest", false, HomeUsuarioController_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.servlet.http.HttpSession", false, HomeUsuarioController_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HomeUsuarioController_ESTest_scaffolding.class.getClassLoader()); 
